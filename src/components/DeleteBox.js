  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full bg-black z-10 bg-opacity-60">
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white w-11/12 max-w-xl rounded p-5 shadow-lg">
        <h1 className="font-bold text-gray-700 text-xl mb-3">Confirm delete</h1>
        ...
        <div className="flex items-center justify-end">
          <button
            ...
            className="mr-3 p-3 border-gray-300 text-gray-500 border rounded"
          >
            Cancel
          </button>
          <button className="mr-3 p-3 font-bold text-white bg-red-500 rounded">
            Delete
          </button>
        </div>
      </div>
